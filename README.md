...
- **Real Calgary youth crime data** (publicly available)
- **Analytical SQL queries**
- **A Power BI dashboard comparing crime trends vs. program engagement**
- **Documentation and ERD diagrams**
...
- Community programs can be a protective factor for youth
## Tools & Technologies
...
## Data Ethics & Privacy
All youth program data is **synthetic** and generated using Python. No real participant information is used. 

Real crime data is sourced from **City of Calgary Open Data**, which is publicly available and anonymized. 
